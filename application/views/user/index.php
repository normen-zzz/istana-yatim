...
<body>
  ...
  <nav class="navbar navbar-light navbar-expand-md fixed-top navigation-clean-button" style="padding-bottom: 0px;padding-top: 0px; border-bottom-style: solid;border-bottom-color: #EBF2F7;">
    <div class="container"><a class="navbar-brand" href="<?= base_url('Home') ?>"><img class="img-fluid pulse animated infinite" src="<?= base_url('assets/images/logo/') ?>istanayatim.jpg"
          style="width: 60px;"></a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span
      ...
      <div class="collapse navbar-collapse" id="navcol-1">
        <ul class="navbar-nav mr-auto">
          ...
          <a class="btn btn-light action-button pulse animated infinite action-button" role="button" href="#donasi">Donasi</a>
        </span>
      </div>
    </div>
  </nav>
  ...
  <section style="margin-top: 54px;">
    <div class="carousel slide" data-ride="carousel" data-interval="2000" data-pause="false" id="carousel-2">
      <div class="carousel-inner" style="max-height: 600px;">
        <?php $counter = 0; ?>
        <?php foreach ($slidefoto as $s) {?>
        <div class="carousel-item <?= ($counter == 0) ? "active" : "" ?>"><img class="w-100 d-block" src="<?= base_url('assets/images/slidefoto/'). $s['img_slidefoto'] ?>" alt="Slide Image"
            style="max-height: 600px;"></div>
        <?php $counter++; } ?>
      </div>
      <div><a class="carousel-control-prev" href="#carousel-2" role="button" data-slide="prev"><span class="carousel-control-prev-icon"></span><span class="sr-only">Previous</span></a><a
          class="carousel-control-next" href="#carousel-2" role="button" data-slide="next"><span class="carousel-control-next-icon"></span><span class="sr-only">Next</span></a></div>
      <ol class="carousel-indicators">
        <?php $counterslide = 0; ?>
        <?php foreach ($slidefoto as $a) { ?>
    ...
    <div class="container">
      <div class="row" style="padding-top: 5px;">
        ...
        <div class="col text-center" style="padding-bottom: 20px;" data-aos="fade-up" data-aos-duration="850"><img src="<?= base_url('assets/images/menu/BERKAH.png') ?>" style="width: 150px;">
          ...
          <a class="btn btn-light action-button" role="button" href="<?= base_url('Berkah-List') ?>"
            style="background: rgb(53,204,95);border-radius: 18px;color: rgb(254,254,254);"><strong>Selengkapnya</strong></a>
        </div>
        ...
        <div class="col text-center" style="padding-bottom: 20px;" data-aos="fade-up" data-aos-duration="850"><img src="<?= base_url('assets/images/menu/Ce.png') ?>" style="width: 150px;">
          ...
          <a class="btn btn-light action-button" role="button" href="<?= base_url('Ceritasantri-List') ?>"
            style="background: rgb(53,204,95);border-radius: 18px;color: rgb(254,254,254);"><strong>Selengkapnya</strong></a>
        </div>
        ...
        <div class="col text-center" style="padding-bottom: 20px;" data-aos="fade-up" data-aos-duration="850"><img src="<?= base_url('assets/images/menu/ISI.png') ?>" style="width: 150px;">
          ...
          <a class="btn btn-light action-button" role="button" href="<?= base_url('Acara-List') ?>"
            style="background: rgb(53,204,95);border-radius: 18px;color: rgb(254,254,254);"><strong>Selengkapnya</strong></a>
        </div>
  ...
  <div class="container" data-aos="fade-up" data-aos-duration="500" data-aos-delay="500">
    ...
    <div class="row owl-carousel">
      ...
      <div class="col" style=" background-color: white; box-shadow: 0px 0px 8px rgb(55,126,79);margin: 5px; padding-top: 0px;">
        <div class="row" style="padding-top: 0px;">
          <div class="col" style="padding-top: 0px;padding-right: 0px;padding-left: 0px;"><img class="img-fluid" src="<?= base_url('assets/images/berkah/'). $b['img_berkah'] ?>"
        ...
        <div class="row" style="padding-top: 0px;">
          <div class="col" style="padding-top: 0px;text-align: center;padding-bottom: 15px;"><a class="btn btn-secondary" href="<?= base_url('Berkah-Detail/'). $b['slug_berkah'] ?>"
              style="width: 168.5px;background: rgba(4,143,131,0);color: rgb(17,156,15);border: 1px solid rgb(17,156,15);box-shadow: 0px 0px 4px 0px;border-radius: 24px;">Selengkapnya</a></div>
        </div>
      </div>
      <!-- akhir -->
      <?php } ?>
    ...
    <section>
      <div class="container">
        ...
        <div class="row">
          <div class="col-xl-8">
            <div class="embed-responsive embed-responsive-16by9"><iframe width="560" height="315" src="<?= $youtube1['link_youtube'] ?>" title="YouTube video player" frameborder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
          </div>
          <div class="col" style="padding-top: 0px;">
            <div class="row" style="padding-top: 0px;">
              <div class="col-xl-12 offset-xl-0" style="padding-top: 0px;">
                <div class="embed-responsive embed-responsive-16by9"><iframe width="560" height="315" src="<?= $youtube2['link_youtube'] ?>" title="YouTube video player" frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
              </div>
            </div>
            <div class="row" style="padding-top: 16px;">
              <div class="col-xl-12 offset-xl-0" style="padding-top: 0px;">
                <div class="embed-responsive embed-responsive-16by9"><iframe width="560" height="315" src="<?= $youtube3['link_youtube'] ?>" title="YouTube video player" frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
              </div>
            </div>
          </div>

      ...
      <div class="col-md-9">
        <div class="row" style="padding-top: 12px;">
          <div class="col" style="padding-top: 0px;">
            ...
            <div><i class="fa fa-clock-o"></i><label style="margin-left: 6px;"><?= strftime("%A %d-%h-%Y %T", strtotime($ceritasantri->tgl_ceritasantri)) ?></label><i class="fa fa-user"
                style="margin-left: 14px;"></i><label style="margin-left: 6px;"><?= $ceritasantri->penulis_ceritasantri ?></label><i class="fa fa-folder" style="margin-left: 14px;"></i><label
                style="margin-left: 6px;"><?= $ceritasantri->jenis_ceritasantri ?></label><i class="fa fa-eye" style="margin-left: 14px;"></i><label
                style="margin-left: 6px;"><?= $ceritasantri->lihat_ceritasantri ?></label><i class="fa fa-comment" style="margin-left: 14px;"></i><label style="margin-left: 6px;">Label</label></div>
          </div>
        </div>
        <div class="row">
        ...
        <div class="row" style="padding-top: 10px;">
          <div class="col-xl-1" style="margin-top: 5px;"><a target="_blank"
              href="http://www.facebook.com/sharer.php?s=100&p[url]=<?= base_url('Ceritasantri-Detail/').$ceritasantri->slug_ceritasantri ?>&p[title]=<?= $ceritasantri->judul_ceritasantri ?>"><img
                src="<?= base_url('assets/user/') ?>img/facebook.png" style="width: 41px;"></a></div>
          <div class="col-xl-1" style="margin-top: 5px;"><a target="_blank" href="https://twitter.com/intent/tweet?url=<?= base_url('Ceritasantri-Detail/'). $ceritasantri->slug_ceritasantri ?>"><img

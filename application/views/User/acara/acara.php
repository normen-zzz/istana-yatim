            ...
            <div class="col-xl-3" style="margin-bottom: 10px;">
                <div class="card"><img class="card-img-top w-100 d-block" src="<?= base_url('assets/images/acara/'). $a['img_acara'] ?>">
                    <div class="card-body" style="text-align: center;">
                        ...
                        <p class="card-text" style="text-align: center;font-family: Aladin, cursive;"><?= strftime("%A %d-%h-%Y %T", strtotime($a['tgl_acara'])) ?></p><a href="<?= base_url('Acara-Detail/'). $a['slug_acara'] ?>" class="btn btn-primary" style="text-align: center;">Selengkapnya</a>
                    </div>
                </div>
            </div>

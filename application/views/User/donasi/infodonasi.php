      ...
      <div class="col-11 col-lg-4 col-xl-3" style="margin-bottom: 10px;">
        <div class="card"><img class="img-fluid card-img-top w-100 d-block" src="<?= base_url('assets/images/pengeluarandonasi/'). $p['img_pengeluaran'] ?>">
          <div class="card-body" style="text-align: center;">
            ...
            <p class="card-text"
              style="text-align: center;font-family: 'Bebas Neue', cursive;margin-bottom: 2px;color: #f2f2f2;border-width: 1px;border-style: solid;border-radius: 21px;background: #28a745;">
              <?= rupiah($p['jumlah_pengeluaran']) ?></p>
          </div>
        </div>
      </div>
      <?php } ?>

    ...
    <div class="container" style="margin-top: 41px;">
        ...
        <div class="row" style="padding-top: 0px;">
            <div class="col-md-9" style="margin-top: 56px;">
                ...
                <div class="row" onclick="window.location='<?= base_url('user/detailartikel/') . $a['slug_artikel']  ?>';" style="padding-top: 10px;border-right: 2px solid rgb(172,174,177) ;">
                    <div class="col-xl-9 offset-xl-1" style="padding-top: 0px;">
                        <div class="card-group">
                            <div class="card"><img class="img-fluid card-img-top w-100 d-block" src="<?= base_url('assets/images/artikel/') . $a['img_artikel'] ?>" style="height: 247.797px;">
                                <div class="card-body">
                                    <h4 class="card-title"><?= $a['judul_artikel'] ?></h4>

                    ...
                    <div class="table-responsive">
                      <table class="table table-bordered table-md">
                        ...
                        <tr>
                          ...
                          <td><a href="<?= base_url('Cms/ubahslidefoto') ?>" class="btn btn-success">Ubah</a> <a href="<?= base_url('Cms/deleteslidefoto/') . $s['id_slidefoto'] ?>" class="btn btn-danger" onclick="return confirm('kamu yakin akan menghapus  ?');">Hapus</a></td>
